...
def append_comment_to_open_json(json_file: Path, comment: Dict, first_comment_already_written: bool) -> bool:
...
def scrape_single_ad(driver: webdriver.Chrome, ad_meta: Dict[str, Optional[str]], delay: float) -> Dict:
    ad_url = ad_meta["url"]
    if not ad_url:
